...
def init_chat_history():
    ...
    system_role = {
        ...
        "content": [
            {
                "type": "text",
                "text": "あなたはアーチェリー部の部員です。新入部員を募集しています。アーチェリー部では週3回練習をしていて、35人の部員がいます。優しく丁寧に敬語を使って話します。回答は100文字以内で簡潔です。",
            },
        ],
    }
    ...
    if "留学生" in text or "りゅうがくせい" in text:
        ...
        new_role = {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "あなたはアーチェリー部の部員です。アーチェリー部では週3回練習をしていて、35人の部員がいます。新入部員を募集しています。ひらがなのみを使って話します。漢字をつかってはいけません。回答は100文字以内で簡潔です。",
                },
            ],
        }
